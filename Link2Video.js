...
/*L2VReplace() was Created by Amuseum, modified by Disowned*/
...
function L2VReplace(x) {
	...
	for (i=0; i<tds.length; i++) {
		...
		td.innerHTML = td.innerHTML.replace(YTSRPATTERN, YTEMPATTERN); //YT SWAP
		td.innerHTML = td.innerHTML.replace(VEOHSRPATTERN, VEOHEMPATTERN); //VEOH SWAP
		td.innerHTML = td.innerHTML.replace(VEOHSRPATTERN2, VEOHEMPATTERN2); //VEOH SWAP
		td.innerHTML = td.innerHTML.replace(VEOHSRPATTERN3, VEOHEMPATTERN2); //VEOH SWAP
		td.innerHTML = td.innerHTML.replace(ASSRPATTERN, ASEMPATTERN); //[adutlswim] SWAP
		td.innerHTML = td.innerHTML.replace(GOOGSRPATTERN, GOOGEMPATTERN); //Google SWAP
		td.innerHTML = td.innerHTML.replace(VIMSRPATTERN, VIMEMPATTERN); //Vimeo
		//alert(td.innerHTML);
	}
}
